...
public class TableModelCentroCosto implements TableModel {

	private LinkedList<CentroCosto> data = new LinkedList<CentroCosto>();

	private LinkedList<TableModelListener> listeners = new LinkedList<TableModelListener>();

	private String[] columnNames = new String[] { "NUMERO", "NOMBRE" };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		CentroCosto object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
	...
	public CentroCosto getObject(int rowIndex) {
	...
	public void addObject(CentroCosto object) {
		data.add(object);
