...
public class GuiTrabajadorNoImponibleUpdate extends JDialog {
	...
	private JLabel jLabelNoImponible;
	 ...
	 */
	public GuiTrabajadorNoImponibleUpdate(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Modificar No Imponible"));
	...
	private JLabel getJLabelNoImponible() {
		if (jLabelNoImponible == null) {
			jLabelNoImponible = new JLabel();
			jLabelNoImponible.setText("No Imponible : ");
		}
		return jLabelNoImponible;
	}
	...
	private JPanel getJPanelTrabajadorNoImponible2() {
		if (jPanelTrabajadorNoImponible2 == null) {
			...
			jPanelTrabajadorNoImponible2.add(getJLabelNoImponible(), "0, 0");
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (this.trabajadorCuenta!=null) {
			if (this.jTextFieldMonto.getText().trim().length() == 0) {
				...
				this.respuesta(
					control.updateTrabajadorNoImponible(
	...
	public void actualizar(TrabajadorCuenta cuenta, TrabajadorNoImponible trabajadorCentro) {
		this.trabajadorCuenta = cuenta;
		this.trabajadorNoImponible = trabajadorCentro;
