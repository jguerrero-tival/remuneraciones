...
public class TableModelTrabajadorNoImponible implements TableModel {

	private LinkedList<TrabajadorNoImponible> data = new LinkedList<TrabajadorNoImponible>();

	private LinkedList<TableModelListener> listeners = new LinkedList<TableModelListener>();

	private String[] columnNames = new String[] { "NO IMPONIBLE", "MONTO ($)" };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		TrabajadorNoImponible object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
			return object.getNoImponible().getNombre();
		case 1:
	...
	public TrabajadorNoImponible getObject(int rowIndex) {
	...
	public void addObject(TrabajadorNoImponible object) {
		data.add(object);
