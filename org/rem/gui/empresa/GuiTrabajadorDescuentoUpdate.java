...
public class GuiTrabajadorDescuentoUpdate extends JDialog {
	 ...
	 */
	public GuiTrabajadorDescuentoUpdate(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Modificar Descuento"));
	...
	private JLabel getJLabelDescuento() {
		if (jLabelDescuento == null) {
			jLabelDescuento = new JLabel();
			jLabelDescuento.setText("Descuento : ");
		}
		return jLabelDescuento;
	}
	...
	private JPanel getJPanelTrabajadorDescuento2() {
		if (jPanelTrabajadorDescuento2 == null) {
			...
			jPanelTrabajadorDescuento2.add(getJLabelDescuento(), "0, 0");
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (this.trabajadorCuenta!=null) {
			if (this.jTextFieldMonto.getText().trim().length() == 0) {
				...
				this.respuesta(
					control.updateTrabajadorDescuento(
	...
	public void actualizar(TrabajadorCuenta cuenta, TrabajadorDescuento trabajadorCentro) {
		this.trabajadorCuenta = cuenta;
		this.trabajadorDescuento = trabajadorCentro;
