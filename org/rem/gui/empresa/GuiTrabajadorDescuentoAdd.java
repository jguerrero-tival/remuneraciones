...
public class GuiTrabajadorDescuentoAdd extends JDialog {
	...
	private JComboBox jComboBoxDescuento;
	 ...
	 */
	public GuiTrabajadorDescuentoAdd(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJPanelTrabajadorDescuento2() {
		if (jPanelTrabajadorDescuento2 == null) {
			...
			jPanelTrabajadorDescuento2.add(getJComboBoxDescuento(), "1, 0");
	...
	private JComboBox getJComboBoxDescuento() {
		if (jComboBoxDescuento == null) {
			jComboBoxDescuento = new JComboBox();
		}
		return jComboBoxDescuento;
	}
	...
	private void jButtonAddActionPerformed(ActionEvent evt) {
		if (this.jComboBoxDescuento.getSelectedIndex()==-1) {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Debe selccionar un \"Descuento\".");
			...
			this.respuesta(
					control.addTrabajadorDescuento(
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Ya existe un registro con el \"Descuento\" ingresado.");
	...
	public void actualizarDatos() {
		this.jComboBoxDescuento.setModel(control.getComboBoxModelDescuento(this.trabajadorCuenta));
		this.limpiar();
	}
