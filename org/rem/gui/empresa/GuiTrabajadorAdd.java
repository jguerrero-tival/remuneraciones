...
public class GuiTrabajadorAdd extends JDialog {

	private Empresa empresa;
	private ControlTrabajador control = new ControlTrabajador();
	private ControlMes controlMes = new ControlMes();
	 ...
	 */
	public GuiTrabajadorAdd(JFrame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Agregar Trabajador"));
	...
	private JFormattedTextField getJFormattedTextFieldRutTrabajador() {
		if (jFormattedTextFieldRutTrabajador == null) {
			...
			jFormattedTextFieldRutTrabajador
				.addFocusListener(new FocusAdapter() {
				public void focusLost(FocusEvent evt) {
					jFormattedTextFieldRutTrabajadorFocusLost(evt);
				}
				});
			jFormattedTextFieldRutTrabajador.addKeyListener(new KeyAdapter() {
				public void keyTyped(KeyEvent evt) {
					jFormattedTextFieldRutTrabajadorKeyTyped(evt);
				}
			});
		}
	...
	private void jFormattedTextFieldRutTrabajadorKeyTyped(KeyEvent evt) {
		Formato.cadenaUpperCase(evt);
	}
	...
	private void jButtonAddActionPerformed(ActionEvent evt) {
		if (this.jFormattedTextFieldRutTrabajador.getText().equals("__.___.___-_")) {
		...
		} else if (!Rut.verificaRut(this.jFormattedTextFieldRutTrabajador.getText())) {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "El campo \"Rut\" no es correcto.");
			...
			this.respuesta(control.addTrabajador(
					this.empresa,
					datosPersonales,
					direccion,
					Fecha.createDate(
	...
	private void actualizar() {
		this.jFormattedTextFieldRutTrabajador.setText("");	
		this.blanquear();
		this.actualizarDia();
	}
	...
	private void blanquear() {
		...
		Date lastFecha = this.controlMes.getFechaLastMes();
		((JSpinner.DefaultEditor)jSpinnerAnno.getEditor()).getTextField().setText(Fecha.getYear(lastFecha).toString());
		this.jComboBoxMes.setSelectedItem(Fecha.getMonthString(lastFecha));
		this.jComboBoxDia.setSelectedItem(Fecha.getDay(lastFecha).toString());
		...
		this.jSpinnerAnno.setEnabled(true);
		this.jComboBoxMes.setEnabled(true);
		this.jComboBoxDia.setEnabled(true);
	}
	
	private void jFormattedTextFieldRutTrabajadorFocusLost(FocusEvent evt) {
		Trabajador trabajador = control.getTrabajadorBloqueado(this.empresa, this.jFormattedTextFieldRutTrabajador.getText());
		if (trabajador!=null) {
			...
			this.jSpinnerAnno.setEnabled(false);
