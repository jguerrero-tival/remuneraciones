...
public class GuiTrabajadorImponibleRemove extends JDialog {

	private TrabajadorCuenta trabajadorCuenta;
	private TrabajadorImponible trabajadorImponible;
	...
	private JTextField jTextFieldImponible;
	 ...
	 */
	public GuiTrabajadorImponibleRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJPanelTrabajadorImponible2() {
		if (jPanelTrabajadorImponible2 == null) {
			...
			jPanelTrabajadorImponible2.add(getJLabelHorasExtraordinarias(), "0, 2");
			jPanelTrabajadorImponible2.add(getJTextFieldHorasExtraordinarias(), "1, 2");
			jPanelTrabajadorImponible2.add(getJTextFieldImponible(), "1, 0");
		}
	...
	private JTextField getJTextFieldImponible() {
		if (jTextFieldImponible == null) {
			jTextFieldImponible = new JTextField();
			jTextFieldImponible.setEditable(false);
		}
		return jTextFieldImponible;
	}
	
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (this.trabajadorCuenta!=null) {
			this.respuesta(
					control.removeTrabajadorImponible(
							this.trabajadorImponible
							));
		
		} else {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Ya se eliminó el \"Imponible\" ingresado.");
		}
	}
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "No existe el \"Imponible\".");
	...
	public void actualizar(TrabajadorCuenta cuenta, TrabajadorImponible trabajadorDesc) {
		this.trabajadorCuenta = cuenta;
		this.trabajadorImponible = trabajadorDesc;
		...
		this.jTextFieldImponible.setText(this.trabajadorImponible.getImponible().getNombre().toString());
		this.jTextFieldMonto.setText(this.trabajadorImponible.getMonto().toString());
	}
	
	private void limpiar() {
		this.trabajadorImponible = null;
		this.trabajadorCuenta = null;
		this.jTextFieldImponible.setText("");
