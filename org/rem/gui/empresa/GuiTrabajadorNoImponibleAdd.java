...
public class GuiTrabajadorNoImponibleAdd extends JDialog {
	...
	private JComboBox jComboBoxNoImponible;
	 ...
	 */
	public GuiTrabajadorNoImponibleAdd(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Agregar No Imponible"));
	...
	private JLabel getJLabelNumero() {
		if (jLabelNumero == null) {
			...
			jLabelNumero.setText("NoImponible : ");
		}
		return jLabelNumero;
	}
	...
	private JPanel getJPanelTrabajadorNoImponible2() {
		if (jPanelTrabajadorNoImponible2 == null) {
			...
			jPanelTrabajadorNoImponible2.add(getJComboBoxNoImponible(), "1, 0");
	...
	private JComboBox getJComboBoxNoImponible() {
		if (jComboBoxNoImponible == null) {
			jComboBoxNoImponible = new JComboBox();
		}
		return jComboBoxNoImponible;
	}
	...
	private void jButtonAddActionPerformed(ActionEvent evt) {
		if (this.jComboBoxNoImponible.getSelectedIndex()==-1) {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Debe selccionar un \"NoImponible\".");
			...
			this.respuesta(
					control.addTrabajadorNoImponible(
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Ya existe un registro con el \"No Imponible\" ingresado.");
	...
	public void actualizarDatos() {
		this.jComboBoxNoImponible.setModel(control.getComboBoxModelNoImponible(this.trabajadorCuenta));
		this.limpiar();
	}
