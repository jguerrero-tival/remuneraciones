...
public class GuiTrabajadorCentroCostoRemove extends JDialog {
	 ...
	 */
	public GuiTrabajadorCentroCostoRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Eliminar Sueldo por Centro de Costo"));
	...
	private JTextField getJTextFieldDiasTrabajados() {
		if (jTextFieldDiasTrabajados == null) {
			...
			jTextFieldDiasTrabajados.setEditable(false);
		}
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (this.trabajadorCuenta!=null) {
			this.respuesta(
					control.removeTrabajadorCentroCosto(
							this.trabajadorCentroCosto
							));
		
		} else {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Ya se eliminó el \"Centro Costo\" ingresado.");
		}
	}
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "No existe el \"Centro de Costo\".");
	...
	private void limpiar() {
		this.trabajadorCentroCosto = null;
