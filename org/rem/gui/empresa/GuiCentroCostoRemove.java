...
public class GuiCentroCostoRemove extends JDialog {
	 ...
	 */
	public GuiCentroCostoRemove(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Eliminar Centro de Costo"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (this.centroCosto!=null && this.empresaCuenta!=null) {
			this.respuesta(control.removeCentroCosto(
					empresaCuenta,
					centroCosto));
		} else {
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			...
			this.actualizar();
		} else if (respuesta == control.respUsandoCentroCosto) {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "No se puede eliminar, esta siendo utilizado por un trabajador.");
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "No se puede eliminar. Corresponde a un Centro de Costos reservado.");
		}
	}
