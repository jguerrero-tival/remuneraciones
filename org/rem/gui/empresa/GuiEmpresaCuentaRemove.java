 ...
 */
public class GuiEmpresaCuentaRemove extends JDialog {
	...
	private JPanel jPanelEmpresaCuentaRemove2;
	...
	private JPanel jPanelEmpresaCuentaRemove;
	 ...
	 * @param owner
	 */
	public GuiEmpresaCuentaRemove(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJPanelTable() {
		if (jPanelTable == null) {
			...
			jPanelTable.add(getJPanelEmpresaCuentaRemove(), "0, 0");
	...
	private JPanel getJPanelEmpresaCuentaRemove() {
		if (jPanelEmpresaCuentaRemove == null) {
			jPanelEmpresaCuentaRemove = new JPanel();
			CardLayout jPanelEmpresaCuentaRemoveLayout = new CardLayout();
			jPanelEmpresaCuentaRemove.setLayout(jPanelEmpresaCuentaRemoveLayout);
			jPanelEmpresaCuentaRemove.setBorder(BorderFactory.createTitledBorder("Fecha"));
			jPanelEmpresaCuentaRemove.add(getJPanelEmpresaCuentaRemove2(), "jPanelEmpresaCuentaRemove2");
		}
		return jPanelEmpresaCuentaRemove;
	}
	...
	private JPanel getJPanelEmpresaCuentaRemove2() {
		if (jPanelEmpresaCuentaRemove2 == null) {
			jPanelEmpresaCuentaRemove2 = new JPanel();
			TableLayout jPanelEmpresaCuentaRemove2Layout = new TableLayout(new double[][] {
					{ TableLayout.FILL }, { TableLayout.FILL } });
			jPanelEmpresaCuentaRemove2Layout.setHGap(5);
			jPanelEmpresaCuentaRemove2Layout.setVGap(5);
			jPanelEmpresaCuentaRemove2.setLayout(jPanelEmpresaCuentaRemove2Layout);
			jPanelEmpresaCuentaRemove2.add(getJScrollPaneTable(), "0, 0");
		}
		return jPanelEmpresaCuentaRemove2;
	}
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		...
		this.respuesta(
			this.control.removeEmpresaCuenta(empresaCuenta));
			this.boorarInfo();
		} else {
	...
	private void respuesta(int respuesta) {
		if (respuesta == control.respExito) {
			Message.timerLabel(this.jLabelRespuesta, Color.green, "El registro se eliminï¿½ exitosamente.");
			...
			Message.timerLabel(this.jLabelRespuesta, Color.red, "No se puede eliminar una cuenta cerrada.");
		}
	}
	...
	private void actualizarDatos() {
		if (empresaCuenta!=null) {
			...
			if (empresaCuenta.getCaja()!=null) {
				...
				this.jTextFieldCaja.setText(Palabra.institucionSin);
			}
			if (empresaCuenta.getMutual()!=null) {
				...
				this.jTextFieldMutual.setText(Palabra.institucionSin);
