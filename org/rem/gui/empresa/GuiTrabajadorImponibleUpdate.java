...
public class GuiTrabajadorImponibleUpdate extends JDialog {
	...
	private JLabel jLabelImponible;
	 ...
	 */
	public GuiTrabajadorImponibleUpdate(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Modificar Imponible"));
	...
	private JLabel getJLabelImponible() {
		if (jLabelImponible == null) {
			jLabelImponible = new JLabel();
			jLabelImponible.setText("Imponible : ");
		}
		return jLabelImponible;
	}
	...
	private JPanel getJPanelTrabajadorImponible2() {
		if (jPanelTrabajadorImponible2 == null) {
			...
			jPanelTrabajadorImponible2.add(getJLabelImponible(), "0, 0");
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (this.trabajadorCuenta!=null) {
			if (this.jTextFieldMonto.getText().trim().length() == 0) {
				...
				this.respuesta(
					control.updateTrabajadorImponible(
	...
	public void actualizar(TrabajadorCuenta cuenta, TrabajadorImponible trabajadorCentro) {
		this.trabajadorCuenta = cuenta;
		this.trabajadorImponible = trabajadorCentro;
