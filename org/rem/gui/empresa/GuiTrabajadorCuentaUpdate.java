...
public class GuiTrabajadorCuentaUpdate extends JDialog {
	...
	private JFormattedTextField jFormattedTextFieldRutTrabajaor;
	 ...
	 */
	public GuiTrabajadorCuentaUpdate(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Modificar Cuenta de Trabajador"));
	...
	private JPanel getJPanelTrabajador2() {
		if (jPanelTrabajador2 == null) {
			...
			jPanelTrabajador2.add(getJFormattedTextFieldRutTrabajaor(), "1, 0");
		}
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (!this.jComboBoxInstitucionPrevision.getSelectedItem().toString().equals(Palabra.institucionSin) && this.jTextFieldAhorroVoluntario.getText().trim().length()==0) {
			...
			this.respuesta(control.updateTrabajadorCuenta(
					empresaCuenta,
	...
	public void actualizar(EmpresaCuenta cuenta, Trabajador trab) {
		...
		this.jFormattedTextFieldRutTrabajaor.setText(this.trabajador.getDatosPersonales().getRut());
		this.jTextFieldAPaterno.setText(this.trabajador.getDatosPersonales().getApellidoPaterno());
		this.jTextFieldAMaterno.setText(this.trabajador.getDatosPersonales().getApellidoMaterno());
		this.jTextFieldNombres.setText(this.trabajador.getDatosPersonales().getNombres());
		this.jTextFieldSexo.setText(this.trabajador.getDatosPersonales().getSexo());
		
		this.jComboBoxTrato.setSelectedItem(this.trabajadorCuenta.getTrato());
		this.jComboBoxFormaPago.setSelectedItem(this.trabajadorCuenta.getFormaPago());
		this.jComboBoxTipoContrato.setSelectedItem(this.trabajadorCuenta.getTipoContrato());
		this.jComboBoxSeguroCesantia.setSelectedItem(Palabra.getBooleanString(this.trabajadorCuenta.isSeguroCesantia()));
		if (this.trabajadorCuenta.getAfp()!=null) {
			this.jComboBoxInstitucionPrevision.setSelectedItem(this.trabajadorCuenta.getAfp().getNombre());
			this.jTextFieldAhorroVoluntario.setText(this.trabajadorCuenta.getValorAhorroVoluntario().toString());
			this.jComboBoxTipoAhorroVoluntario.setSelectedItem(this.trabajadorCuenta.getTipoAhorroVoluntario());
			if (this.jComboBoxSeguroCesantia.getSelectedItem().equals(Palabra.booleanTrue) 
					&& controlAfp.getRegimen(fecha, this.jComboBoxInstitucionPrevision.getSelectedItem().toString())
					.equals(Palabra.regimenAntiguo)) {
				this.jComboBoxInstitucionPrevision2.setEnabled(true);
				this.jComboBoxInstitucionPrevision2.setSelectedItem(this.trabajadorCuenta.getAfp2().getNombre());
			} else {
				this.jComboBoxInstitucionPrevision2.setEnabled(false);
			}
		} else {
			this.jComboBoxInstitucionPrevision.setSelectedIndex(0);
			this.jTextFieldAhorroVoluntario.setText("0");
			this.jComboBoxTipoAhorroVoluntario.setSelectedIndex(0);
			this.jComboBoxInstitucionPrevision2.setEnabled(false);
		}
		if (this.trabajadorCuenta.getIsapre()!=null) {
			this.jComboBoxInstitucionSalud.setSelectedItem(this.trabajadorCuenta.getIsapre().getNombre());
			this.jTextFieldPactoIsapre.setText(this.trabajadorCuenta.getValorPactoIsapre().toString());
			this.jComboBoxTipoPactoIsapre.setSelectedItem(this.trabajadorCuenta.getTipoPactoIsapre());
		} else {
			this.jComboBoxInstitucionSalud.setSelectedIndex(0);
			this.jTextFieldPactoIsapre.setText("0");
			this.jComboBoxTipoPactoIsapre.setSelectedIndex(0);
		}
		this.jComboBoxCargas.setSelectedItem(Palabra.getBooleanString(this.trabajadorCuenta.isCargas()));
		if (this.trabajadorCuenta.isCargas().booleanValue()) {
			this.jTextFieldSueldoPromedio.setText(this.trabajadorCuenta.getSueldoPromedio().toString());
			this.jTextFieldCargasNormales.setText(this.trabajadorCuenta.getNumeroCargasNormal().toString());
			this.jTextFieldCargasInvalidas.setText(this.trabajadorCuenta.getNumeroCargasInvalida().toString());
		} else {
			this.jTextFieldSueldoPromedio.setText("0");
			this.jTextFieldCargasNormales.setText("0");
			this.jTextFieldCargasInvalidas.setText("0");
		}
	}
	
	private JFormattedTextField getJFormattedTextFieldRutTrabajaor() {
		if (jFormattedTextFieldRutTrabajaor == null) {
			jFormattedTextFieldRutTrabajaor = new JFormattedTextField(Formato
					.getMaskRut());
			jFormattedTextFieldRutTrabajaor.setEditable(false);
		}
		return jFormattedTextFieldRutTrabajaor;
	}
