...
public class GuiImpuestoRemove extends JDialog {
	 ...
	 */
	public GuiImpuestoRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar un Tramo de Impuesto Único"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxImpuesto.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeImpuesto(fecha, new Double(this.jComboBoxImpuesto.getSelectedItem().toString())));
	...
	private void actualizarCombo() {
		this.jComboBoxImpuesto.setModel(control.getComboBoxModelImpuestoInicioNoCasiFijo(fecha));
		this.actualizarDatos();
	}
