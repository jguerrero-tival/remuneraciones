...
public class TableModelMoneda implements TableModel {

	private LinkedList<Moneda> data = new LinkedList<Moneda>();

	private LinkedList<TableModelListener> listeners = new LinkedList<TableModelListener>();

	private String[] columnNames = new String[] { "VALOR", "TIPO" };

	private Class[] columnClass = new Class[] { Double.class, String.class };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Moneda object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
	...
	public Moneda getObject(int rowIndex) {
	...
	public void addObject(Moneda object) {
		data.add(object);
