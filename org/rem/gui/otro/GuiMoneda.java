...
import org.rem.control.otro.ControlTableModelMoneda;
 ...
 */
public class GuiMoneda extends JDialog {

	private ControlTableModelMoneda control = new ControlTableModelMoneda();

	private GuiMonedaAdd guiAdd = new GuiMonedaAdd(this);

	private GuiMonedaRemove guiRemove = new GuiMonedaRemove(this);

	private GuiMonedaUpdate guiUpdate = new GuiMonedaUpdate(this);
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Detalle de Efectivo"));
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelMoneda());
	}
