...
import org.rem.control.haberDescuento.ControlTableModelImponible;
 ...
 */
public class GuiImponible extends JDialog {

	private ControlTableModelImponible control = new ControlTableModelImponible();

	private GuiImponibleAdd guiAdd = new GuiImponibleAdd(this);

	private GuiImponibleRemove guiRemove = new GuiImponibleRemove(this);

	private GuiImponibleUpdate guiUpdate = new GuiImponibleUpdate(this);
	 ...
	 * @param owner
	 */
	public GuiImponible(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Haberes Imponibles"));
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelImponible());
	}
