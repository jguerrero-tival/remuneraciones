...
public class TableModelDescuento implements TableModel {

	private LinkedList<Descuento> data = new LinkedList<Descuento>();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Descuento object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
	...
	public Descuento getObject(int rowIndex) {
	...
	public void addObject(Descuento object) {
		data.add(object);
