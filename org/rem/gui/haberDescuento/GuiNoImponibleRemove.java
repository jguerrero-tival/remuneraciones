...
public class GuiNoImponibleRemove extends JDialog {
	 ...
	 */
	public GuiNoImponibleRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar Haber No Imponible"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxNoImponible.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeNoImponible(this.jComboBoxNoImponible.getSelectedItem().toString()));
		}
	}
	...
	public void actualizar() {
		jComboBoxNoImponible.setModel(control.getComboBoxModelNoImponibleNoBloqueadoNoFijo());
	}
