...
public class GuiDescuentoRemove extends JDialog {
	 ...
	 */
	public GuiDescuentoRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar Descuento"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxDescuento.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeDescuento(this.jComboBoxDescuento.getSelectedItem().toString()));
		}
	}
	...
	public void actualizar() {
		jComboBoxDescuento.setModel(control.getComboBoxModelDescuentoNoBloqueadoNoFijo());
	}
