...
public class TableModelImponible implements TableModel {

	private LinkedList<Imponible> data = new LinkedList<Imponible>();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Imponible object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
	...
	public Imponible getObject(int rowIndex) {
	...
	public void addObject(Imponible object) {
		data.add(object);
