...
import org.rem.control.haberDescuento.ControlTableModelDescuento;
 ...
 */
public class GuiDescuento extends JDialog {

	private ControlTableModelDescuento control = new ControlTableModelDescuento();

	private GuiDescuentoAdd guiAdd = new GuiDescuentoAdd(this);

	private GuiDescuentoRemove guiRemove = new GuiDescuentoRemove(this);

	private GuiDescuentoUpdate guiUpdate = new GuiDescuentoUpdate(this);
	 ...
	 * @param owner
	 */
	public GuiDescuento(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelDescuento());
	}
