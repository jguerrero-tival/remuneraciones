...
public class GuiDescuentoAdd extends JDialog {

	private ControlDescuento control = new ControlDescuento();
	 ...
	 */
	public GuiDescuentoAdd(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private void jButtonAddActionPerformed(ActionEvent evt) {
		if (jTextFieldNombre.getText().trim().length() == 0) {
			...
			this.respuesta(control.addDescuento(this.jTextFieldNombre.getText().trim()));
		}
	}
