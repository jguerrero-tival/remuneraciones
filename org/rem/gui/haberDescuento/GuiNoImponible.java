...
import org.rem.control.haberDescuento.ControlTableModelNoImponible;
 ...
 */
public class GuiNoImponible extends JDialog {

	private ControlTableModelNoImponible control = new ControlTableModelNoImponible();

	private GuiNoImponibleAdd guiAdd = new GuiNoImponibleAdd(this);

	private GuiNoImponibleRemove guiRemove = new GuiNoImponibleRemove(this);

	private GuiNoImponibleUpdate guiUpdate = new GuiNoImponibleUpdate(this);
	 ...
	 * @param owner
	 */
	public GuiNoImponible(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Haberes No Imponibles"));
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelNoImponible());
	}
