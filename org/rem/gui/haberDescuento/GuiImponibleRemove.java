...
public class GuiImponibleRemove extends JDialog {
	 ...
	 */
	public GuiImponibleRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar Haber Imponible"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxImponible.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeImponible(this.jComboBoxImponible.getSelectedItem().toString()));
		}
	}
	...
	public void actualizar() {
		jComboBoxImponible.setModel(control.getComboBoxModelImponibleNoBloqueadoNoFijo());
	}
