...
import org.rem.control.institucion.ControlTableModelMutual;
 ...
 */
public class GuiMutual extends JDialog {

	private ControlTableModelMutual control = new ControlTableModelMutual();

	private GuiMutualAdd guiAdd = new GuiMutualAdd(this);

	private GuiMutualRemove guiRemove = new GuiMutualRemove(this);

	private GuiMutualUpdate guiUpdate = new GuiMutualUpdate(this);
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelMutual());
	}
