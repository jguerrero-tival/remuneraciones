...
public class GuiIsapreRemove extends JDialog {
	 ...
	 */
	public GuiIsapreRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar Isapre"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxIsapre.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeIsapre(this.jComboBoxIsapre.getSelectedItem().toString()));
		}
	}
	...
	public void actualizar() {
		jComboBoxIsapre.setModel(control.getComboBoxModelIsapreNoBloqueado());
	}
