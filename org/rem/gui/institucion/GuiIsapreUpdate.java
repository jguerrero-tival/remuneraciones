...
public class GuiIsapreUpdate extends JDialog {
	...
	private JComboBox jComboBoxIsapre = new JComboBox();
	 ...
	 */
	public GuiIsapreUpdate(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Modificar Isapre"));
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jPanel.add(jComboBoxIsapre, "2, 1");
			jComboBoxIsapre.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					jComboBoxIsapreActionPerformed(evt);
				}
			});
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (jComboBoxIsapre.getSelectedIndex()==-1) {
			Message.timerLabel(this.jLabelRespuesta, Color.red, "Debe seleccionar un \"Isapre\".");
		}
			...
			this.respuesta(control.updateIsapre( 
	...
	private void jComboBoxIsapreActionPerformed(ActionEvent evt) {
		this.actualizarCampos();
	}
	
	private void actualizarCampos() {
		if (this.jComboBoxIsapre.getSelectedIndex()!=-1) {
			this.jTextFieldNombre.setText( this.jComboBoxIsapre.getSelectedItem().toString()); 
		}
	}
	
	public void actualizar() {
		this.jComboBoxIsapre.setModel(control.getComboBoxModelIsapreNoBloqueado());
		this.actualizarCampos();
	}
