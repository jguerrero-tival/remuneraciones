...
import org.rem.control.institucion.ControlTableModelCaja;
 ...
 */
public class GuiCaja extends JDialog {

	private ControlTableModelCaja control = new ControlTableModelCaja();

	private GuiCajaAdd guiAdd = new GuiCajaAdd(this);

	private GuiCajaRemove guiRemove = new GuiCajaRemove(this);

	private GuiCajaUpdate guiUpdate = new GuiCajaUpdate(this);
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory
					.createTitledBorder("Caja de Compensación"));
	...
	private void actualizar() {
		this.jTable.setModel(control.getTableModelCaja());
	}
