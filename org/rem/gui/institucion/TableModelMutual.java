...
public class TableModelMutual implements TableModel {

	private LinkedList<Mutual> data = new LinkedList<Mutual>();
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Mutual object = data.get(rowIndex);
		switch (columnIndex) {
		case 0:
	...
	public Mutual getObject(int rowIndex) {
	...
	public void addObject(Mutual object) {
		data.add(object);
