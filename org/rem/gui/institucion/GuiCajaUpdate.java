...
public class GuiCajaUpdate extends JDialog {
	 ...
	 */
	public GuiCajaUpdate(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Modificar Caja de Compensación"));
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jComboBoxCaja.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					jComboBoxCajaActionPerformed(evt);
				}
			});
	...
	private void jButtonUpdateActionPerformed(ActionEvent evt) {
		if (jComboBoxCaja.getSelectedIndex()==-1) {
			...
			this.respuesta(control.updateCaja( 
					this.jComboBoxCaja.getSelectedItem().toString(), 
	...
	private void jComboBoxCajaActionPerformed(ActionEvent evt) {
		this.actualizarCampos();
	}
	
	private void actualizarCampos() {
		if (this.jComboBoxCaja.getSelectedIndex()!=-1) {
			this.jTextFieldNombre.setText( this.jComboBoxCaja.getSelectedItem().toString()); 
		}
	}
	
	public void actualizar() {
		this.jComboBoxCaja.setModel(control.getComboBoxModelCajaNoBloqueado());
		this.actualizarCampos();
	}
