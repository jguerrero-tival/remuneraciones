...
public class GuiMutualRemove extends JDialog {
	 ...
	 */
	public GuiMutualRemove(JDialog owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.setBorder(BorderFactory.createTitledBorder("Eliminar Mutual de Seguridad"));
	...
	private void jButtonRemoveActionPerformed(ActionEvent evt) {
		if (jComboBoxMutual.getSelectedIndex()==-1) {
			...
			this.respuesta(control.removeMutual(this.jComboBoxMutual.getSelectedItem().toString()));
		}
	}
	...
	public void actualizar() {
		jComboBoxMutual.setModel(control.getComboBoxModelMutualNoBloqueado());
	}
