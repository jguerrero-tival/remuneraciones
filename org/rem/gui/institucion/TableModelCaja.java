...
public class TableModelCaja implements TableModel {

	private LinkedList<Caja> data = new LinkedList<Caja>();
	...
	public Caja getObject(int rowIndex) {
	...
	public void addObject(Caja object) {
		data.add(object);
