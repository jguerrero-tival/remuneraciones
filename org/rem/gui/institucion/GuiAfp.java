...
import org.rem.control.institucion.ControlTableModelAfp;
 ...
 */
public class GuiAfp extends JDialog {

	private ControlTableModelMes controlModelMes = new ControlTableModelMes();
	private ControlTableModelAfp controlModelAfp = new ControlTableModelAfp();
	private GuiAfpAdd guiAdd = new GuiAfpAdd(this);
	private GuiAfpUpdate guiUpdate = new GuiAfpUpdate(this);
	private GuiAfpRemove guiRemove = new GuiAfpRemove(this);
	...
	private JPanel getJPanelVariables() {
		if (jPanelVariables == null) {
			...
			jPanelVariables.setBorder(BorderFactory.createTitledBorder("AFPs por mes"));
	...
	private void actualizarDatos() {
		if (jTable.getSelectedRow()!=-1) {
			...
			this.jTableAsignacion.setModel(controlModelAfp.getTableModelAfp(fecha));
			this.jButtonAdd.setEnabled(true);
			this.jButtonUpdate.setEnabled(true);
			this.jButtonRemove.setEnabled(true);
		} else {
			this.jTableAsignacion.setModel(new TableModelAfp());
